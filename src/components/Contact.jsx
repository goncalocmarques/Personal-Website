const Contact = () => {
    ...
    const iconsWidth = screenWidth > 500 ? 100 : 70;
    const iconsHeight = iconsWidth;
    return (
        <section className="flex flex-col gap-16 justify-center items-center bg-backgroundColor">
            <h3 className="sm:text-4xl text-2xl">I hope to hear from you soon!</h3>
            <h4 className="sm:text-3xl text-xl">Contact me:</h4>
            <section>
                <ul className="flex flex-row sm:gap-20 gap-5">
                    <li>
