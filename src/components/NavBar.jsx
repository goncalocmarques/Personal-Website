...
function NavBar() {
    ...
    return (
      <nav className="flex flex-col items-center h-10 bg-backgroundColor">
        ...
        <ul className="hidden sm:flex flex-row justify-center gap-8 items-center w-96 my-5 p-10 h-10 rounded-3xl stroke-gray-500 shadow-2xl bg-slate-50 list-none">
            ...
            <li className="flex items-center justify-center bg-slate-500 rounded-3xl "><Link to="#" className="w-24 p-2 text-center text-white ">Contact</Link></li>
        </ul>
      </nav>
